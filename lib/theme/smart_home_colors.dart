...
class SmartHomeColors extends ThemeExtension<SmartHomeColors> {
  ...
  static final SmartHomeColors dark = SmartHomeColors(
    scaffoldBackground: const Color(0xFF0F1B33),
    card: const Color(0xFF162847),
    inputFill: const Color(0xFF1C3255),
    textPrimary: const Color(0xFFE8EEF8),
    textSecondary: const Color(0xFF8FA3C4),
    surfaceElevated: const Color(0xFF243B5E),
    planCanvasBg: const Color(0xFF0F1B33),
    planRoomIdle: const Color(0xE6162847),
    planRoomSelectedFill: const Color(0x336D9A78),
    planBorder: const Color(0xFF2E4A6E),
